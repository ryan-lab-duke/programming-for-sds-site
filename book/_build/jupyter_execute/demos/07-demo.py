...
# From the data summary, we can see that there are six missing values in the dicharge column. There are many ways to handle these values and there is no "best" way that can be used for every task. We will zoom in on one of these missing values to demonstrate.
